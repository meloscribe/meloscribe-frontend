      ...
      <div className="max-w-7xl mx-auto">
        ...
        {activeTab === 'packages' && (
          <div className="space-y-6">
            <div className="bg-neon-cyan/5 border border-neon-cyan/25 rounded-xl p-4 text-xs text-neon-cyan leading-relaxed flex items-start gap-2.5 max-w-2xl">
          ...
          <div className="space-y-6">
            <div className="bg-neon-pink/5 border border-neon-pink/25 rounded-xl p-4 text-xs text-neon-pink leading-relaxed flex items-start gap-2.5 max-w-2xl">
              ...
              <div>
                ...
                <p className="text-gray-650 dark:text-gray-450 mt-0.5">
                  Hier siehst du alle registrierten Zahlungen. Du kannst für jeden Kunden seinen Download-Klickzähler (Limit: 100) zurücksetzen, falls er das Limit erreicht hat und wieder Zugriff benötigt.
                </p>
              </div>
            </div>
