        ...
        <div className="bg-white/80 dark:bg-dark-800/80 backdrop-blur-xl border border-gray-200 dark:border-dark-500/50 rounded-2xl p-8 sm:p-10 shadow-2xl relative">
          ...
          <div className="space-y-8 text-gray-600 dark:text-gray-300 leading-relaxed font-sans">
            ...
            <div>
              ...
              <p className="text-sm">
                {language === 'de'
                   ? 'Um eine Rückerstattung zu beantragen, wende dich bitte unter Angabe deiner Bestell- und Transaktionsnummer an <a href="mailto:info@meloscribe.dev" class="text-neon-cyan hover:underline">info@meloscribe.dev</a>. Wir prüfen alle berechtigten Erstattungsanträge zeitnah und führen die Rückzahlung über unseren Zahlungsdienstleister Stripe durch.'
                   : 'To request a refund, please contact us at <a href="mailto:info@meloscribe.dev" class="text-neon-cyan hover:underline">info@meloscribe.dev</a> with your order and transaction reference. We process all eligible refund requests promptly and execute returns via our payment provider Stripe.'}
              </p>
            </div>
