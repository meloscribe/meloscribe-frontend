        ...
        <div className="bg-white/80 dark:bg-dark-800/80 backdrop-blur-xl border border-gray-200 dark:border-dark-500/50 rounded-2xl p-8 sm:p-10 shadow-2xl relative">
          ...
          <div className="space-y-8 text-gray-600 dark:text-gray-300 leading-relaxed font-sans">
            ...
            <div>
              ...
              <p className="text-sm">
                {language === 'de'
                  ? 'Um eine Rückerstattung zu beantragen, wende dich bitte unter Angabe deines Kaufbelegs und der Rechnungsnummer an ventoba.sm@gmail.com. Unser Händler Paddle bearbeitet alle berechtigten Rückerstattungsanträge.'
                  : 'To request a refund, please contact us at ventoba.sm@gmail.com with your proof of purchase and invoice number. Our billing partner Paddle handles the processing of all approved refund requests.'}
              </p>
            </div>
