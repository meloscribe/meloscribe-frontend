...
const translations = {
  ...
  de: {
    ...
    merchantOfRecord: 'Zahlungsabwickler: Stripe',
    ...
    originalVideoLabel: 'Video (Originalgeschwindigkeit)',
    originalVideoTooltip: 'Das 2K HD Keysight Visualisierungsvideo in Originalgeschwindigkeit zum Mitspielen offline.',
    originalVideoDesc: 'Video in Originalgeschwindigkeit (2K HD MP4).',
    videoBtnText: 'Video laden',
    slowVideoLabel: 'Video (Verlangsamt zum Üben)',
    ...
    slowVideoDesc: 'Video im langsamen Tempo (2K HD MP4).',
  ...
  es: {
    ...
    originalVideoLabel: 'Video (Velocidad original)',
    originalVideoTooltip: 'El video de visualización de Keysight 2K HD a velocidad completa para referencia sin conexión.',
    originalVideoDesc: 'Video a velocidad completa (2K HD MP4).',
    videoBtnText: 'Descargar video',
    slowVideoLabel: 'Video (Velocidad de práctica lenta)',
    ...
    slowVideoDesc: 'Video en ritmo lento (2K HD MP4).',
