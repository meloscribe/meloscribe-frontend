...
const translations = {
  en: {
    ...
    popularDesc: 'Discover our most popular piano sheets and arrangements',
  ...
  de: {
    ...
    popularArrangements: 'Trending Arrangements',
    popularDesc: 'Entdecke unsere beliebtesten Klaviernoten und Arrangements',
    downloadSheets: 'Noten kaufen',
    currentlyDisabled: 'Derzeit nicht verfügbar',
    getOnArrangeMe: 'Auf Sheet Music Direct holen',
  ...
  fr: {
    ...
    popularDesc: 'Découvrez nos partitions de piano et arrangements les plus populaires',
    downloadSheets: 'Acheter',
    currentlyDisabled: 'Actuellement indisponible',
    getOnArrangeMe: 'Obtenir sur Sheet Music Direct',
  ...
  es: {
    ...
    popularDesc: 'Descubre nuestros arreglos y partituras más populares',
    downloadSheets: 'Comprar',
    currentlyDisabled: 'Actuellement no disponible',
    getOnArrangeMe: 'Obtener en Sheet Music Direct',
  ...
  it: {
    ...
    popularDesc: 'Scopri i nostri spartiti e arrangiamenti più popolari',
    downloadSheets: 'Acquista',
    currentlyDisabled: 'Attualmente non disponibile',
    getOnArrangeMe: 'Ottieni su Sheet Music Direct',
